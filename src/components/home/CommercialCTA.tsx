    ...
    <section className="py-20 bg-zinc-900/40 relative overflow-hidden border-b border-white/10">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <motion.div
          ...
          className="p-8 sm:p-12 md:p-16 rounded-lg bg-zinc-900 border border-white/10 shadow-2xl space-y-6"
        >
          <div className="inline-block px-3 py-1 border border-red-600/30 bg-red-600/10 text-red-500 text-[10px] font-bold uppercase tracking-widest rounded-sm">
            Atendimento Consultivo Corporativo
          </div>
          ...
          <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
            <button
              ...
              className="w-full sm:w-auto px-8 py-4 rounded-sm bg-red-600 hover:bg-red-700 text-white font-bold text-xs uppercase tracking-wider shadow-lg transition-all duration-200 active:scale-98 flex items-center justify-center gap-2 group cursor-pointer"
            >
            ...
            <a
              ...
              className="w-full sm:w-auto px-8 py-4 rounded-sm bg-zinc-800 hover:bg-zinc-700 text-white font-bold text-xs uppercase tracking-wider border border-white/10 transition-all duration-200 flex items-center justify-center gap-2 cursor-pointer"
            >
          ...
          <div className="pt-4 flex flex-wrap items-center justify-center gap-6 text-[11px] text-zinc-400 font-mono">
            <span>• PROPOSTA EM ATÉ 2 HORAS</span>
            <span>• CONTRATOS FLEXÍVEIS</span>
            <span>• FATURAMENTO B2B</span>
          </div>
        </motion.div>
